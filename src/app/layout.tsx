...
export const metadata: Metadata = {
  ...
  description:
    "20 yıllık tecrübemizle CPAP, BiPAP ve solunum cihazları satışı ve teknik desteği. Uyku apnesi ve KOAH hastaları için profesyonel çözümler.",
  keywords: [
    "cpap",
    "cpap cihazı",
    "otomatik cpap",
  ...
  twitter: {
    ...
    title: "Dönüşüm Medikal - CPAP ve Solunum Cihazları",
    description:
      "20 yıllık tecrübemizle CPAP, BiPAP ve solunum cihazları satışı ve teknik desteği.",
    images: ["/og-image.jpg"],
  },
  verification: {
    ...
    <html lang="tr">
      <head>
        ...
        <meta
          ...
          content="eIeEpBNc1oC_vGcfVVYQ8GWg9N_TiDlN4eYYPEN_Uas"
        />
        ...
        <meta
          name="DC.title"
          content="Dönüşüm Medikal - CPAP ve Solunum Cihazları"
        />
        <meta name="DC.creator" content="Dönüşüm Medikal" />
        <meta
          name="DC.subject"
          content="CPAP, BiPAP, Solunum Cihazları, Uyku Apnesi"
        />
        <meta
          name="DC.description"
          content="20 yıllık tecrübemizle CPAP, BiPAP ve solunum cihazları satışı ve teknik desteği."
        />
